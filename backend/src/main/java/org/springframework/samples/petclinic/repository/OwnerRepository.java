...
public interface OwnerRepository extends Repository<Owner, Integer>, JpaSpecificationExecutor<Owner> {
     ...
     *
     * @param petTypeName the name of the pet type to filter by (case-insensitive)
     * @param specialtyName the name of the vet specialty to filter by (case-insensitive)
     * @return a distinct list of owner full names (firstName + lastName), ordered by last name then first name
     */
    @Query("""
