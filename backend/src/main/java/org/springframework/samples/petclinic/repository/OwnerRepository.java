...
public interface OwnerRepository extends Repository<Owner, Integer>, JpaSpecificationExecutor<Owner> {
     ...
     * 
     * @param petTypeName the pet type name to filter by (case-insensitive)
     * @param specialtyName the veterinary specialty name to filter by (case-insensitive)
     * @return a list of distinct owner full names (firstName + lastName), sorted alphabetically
     */
    @Query("""
