...
public interface OwnerRepository extends Repository<Owner, Integer>, JpaSpecificationExecutor<Owner> {
    ...
    /**
     * Find all owners who have pets of a specific type and have used veterinary services
     ...
     * @return a list of Object arrays where each array contains [firstName, lastName]
     */
